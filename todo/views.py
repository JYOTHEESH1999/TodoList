    ...
    if request.method == 'GET':
        ...
        if request.POST['password1']==request.POST['password2']:
            try:
                ...
                return render(request, 'todo/signup.html',{'form': UserCreationForm(), 'error': 'Username already exists try another user name'})
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': TodoForm(),'error':'title can have maximum 100 characters only'})
@login_required
